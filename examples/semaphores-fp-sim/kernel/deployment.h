...
#define POK_CONFIG_SCHEDULING_SLOTS {4000000000, 20000000000, 1000000000, 10000000000}
...
#define POK_CONFIG_PARTITIONS_NTHREADS  {8,2}
#define POK_CONFIG_PARTITIONS_NLOCKOBJECTS  {1,0}

#define POK_CONFIG_PARTITIONS_SCHEDULER {POK_SCHED_FP, POK_SCHED_FP}
